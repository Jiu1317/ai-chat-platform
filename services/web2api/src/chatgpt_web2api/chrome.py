...
class ChromeProcess:
    ...
    async def _launch(self) -> None:
        ...
        if self._cfg.headless:
            ...
            # Keep the dedicated automation browser out of the user's way.
    ...
    async def _cdp_alive(self) -> bool:
        ...
        try:
            ...
            # HTTP(S)_PROXY settings; otherwise urllib can send this health
            # probe to a desktop proxy and falsely conclude that Chrome is
            # down, then launch a duplicate profile instance.
